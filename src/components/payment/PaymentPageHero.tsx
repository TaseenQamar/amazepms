...
export default function PaymentPageHero() {
  ...
  return (
    ...
    >
      ...
      >
        <Image
          src="https://images.unsplash.com/photo-1563013544-824ae1b704d3?auto=format&fit=crop&w=2400&q=80"
          alt="Payment Methods"
          fill
          priority
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-navy/92 via-navy/78 to-navy/55" />
      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl px-6 pb-12 pt-28 text-center">
        <PageHeroTitle title="Payment" crumb="Payment Methods" />
      </div>
    </section>
  );
}
