...
export default function StrengthPageHero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-navy/88 via-navy/72 to-navy/55" />
      ...
      <div className="pointer-events-none absolute -right-16 top-8 h-72 w-72 rounded-full border border-white/10" />

      <div className="relative z-10 mx-auto w-full max-w-6xl px-6 pb-12 pt-28 text-center">
        <PageHeroTitle title="Our Strength" crumb="Our Strength" />
      </div>
    </section>
  );
}
